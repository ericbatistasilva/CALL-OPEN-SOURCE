...
- Manual sending of photos + text to the AI
- Text-to-speech (TTS) of AI responses
...
2. Open the `index.html` file in your browser (Chrome or Edge recommended).
...
If you make changes, share them on your fork or send a PR to contribute!
